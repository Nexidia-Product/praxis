...
| File                     | Contents                                            |
| ------------------------ | --------------------------------------------------- |
| `projects.json`          | 11 projects (Tiger Team migration)                  |
| `tasks.json`             | 40 tasks (4 with `estimate_hours` set from ranges)  |
| `ideas.json`             | 3 sample ideas                                      |
| `users.json`             | One default Admin user                              |
| `notifications.json`     | `[]`                                                |
| `decisions.json`         | `[]`                                                |
| `templates.json`         | `[]`                                                |
| `settings.json`          | `{}` (defaults applied at read time)                |
| `users-to-invite.json`   | 8 names collected from the spreadsheet              |
